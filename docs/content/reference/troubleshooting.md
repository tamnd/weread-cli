...
Most of these come down to network reality or how weread serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

weread rate-limits like any public site. weread already paces
...
Where a surface is gated, weread reads a cookie or token you supply
...
`weread`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what weread actually did
